...
class Test_Integrate_TELL_NEW_FILE_Ceph_DataCopy(unittest.TestCase):
    def setUp(self):
    ...
    def test_get_hash_for_new_file(self):
        """get the hash for a new file from the ceph cluster

        """
        time.sleep(60)          # wait for the index creation
        self.queue_sim_datacopy_new_file.put({'sha1sum': '', 'namespace': 'eo_mesh', 'key': 'universe.fo.nodal.z1.eo@000000000.000000'})
        res = self.queue_datacopy_backend_new_file_and_hash.get(10)
        self.assertEqual(res, {'sha1sum': '1cf0ae170f866d5caf5b0695f2f10a9d0972b8a6', 'namespace': 'eo_mesh', 'key': 'universe.fo.nodal.z1.eo@000000000.000000'})
        # eo_mesh/universe.fo.nodal.z1.eo@000000000.000000/1cf0ae170f866d5caf5b0695f2f10a9d0972b8a6
